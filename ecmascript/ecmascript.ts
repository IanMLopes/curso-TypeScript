...
const cpf: string = '123.456.345.34'
// cpf = '124.323.456-58'
console.log(cpf)
...
const falarCom = (pessoa: string) => console.log('Óla' + pessoa)
falarCom("João")
...
function tuplaParams(...params: [number, string, boolean]) {
